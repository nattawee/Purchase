...
describe('Client CRUD tests', function () {
          ...
          .end(function (clientSaveErr, clientSaveRes) {
            ...
            agent.get('/api/clients')
              .end(function (clientsGetErr, clientsGetRes) {
                ...
                (clients[0].fname).should.match('Client fname');
  ...
  it('should not be able to save an Client if no fname is provided', function (done) {
    // Invalidate fname field
    client.fname = '';
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/clients')
          ...
          .end(function (clientSaveErr, clientSaveRes) {
            ...
            (clientSaveRes.body.message).should.match('Please fill Client fname');
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/clients')
          ...
          .end(function (clientSaveErr, clientSaveRes) {
            ...
            // Update Client fname
            client.fname = 'WHY YOU GOTTA BE SO MEAN?';
            ...
            agent.put('/api/clients/' + clientSaveRes.body._id)
              ...
              .end(function (clientUpdateErr, clientUpdateRes) {
                ...
                (clientUpdateRes.body.fname).should.match('WHY YOU GOTTA BE SO MEAN?');
  ...
  it('should be able to get a single Client if not signed in', function (done) {
    ...
    clientObj.save(function () {
      request(app).get('/api/clients/' + clientObj._id)
        .end(function (req, res) {
          // Set assertion
          res.body.should.be.instanceof(Object).and.have.property('fname', client.fname);
        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/clients')
            ...
            .end(function (clientSaveErr, clientSaveRes) {
              ...
              (clientSaveRes.body.fname).should.equal(client.fname);
                  ...
                  .end(function (err, res) {
                    ...
                    agent.get('/api/clients/' + clientSaveRes.body._id)
                      ...
                      .end(function (clientInfoErr, clientInfoRes) {
                        ...
                        (clientInfoRes.body.fname).should.equal(client.fname);
